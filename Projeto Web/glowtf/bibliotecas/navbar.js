        ...
        result = `
          <div class="usuario-autenticado">
            ...
            <li>
              ...
              <ul class="dropdown">
                <li><a class="small-desejos" onclick="MoverPagina('../lista_de_desejos/lista_de_desejos.html')">Lista de Desejos</a></li>
                <li><a class="small-carrinho" onclick="MoverPagina('../carrinho/carrinho.html')">Carrinho</a></li>
